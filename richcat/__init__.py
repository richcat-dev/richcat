from .richcat import infer_filetype, print_rich
...
#         # console = Console()
#         print(r'[bold red]\[richcat error][/bold red]: Cloud not get terminal width. Please give terminal width by using "width" option.')
